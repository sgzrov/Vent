...
const agents = [
  ...
  },
  {
    name: "Codex",
    icon: (
      <svg viewBox="3 3 18 18" className="w-4 h-4">
  ...
  },
  {
    name: "Cursor",
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="#000000" fillRule="evenodd">
  ...
  },
  {
    name: "Windsurf",
    icon: (
      <svg viewBox="0 0 1024 1024" className="w-5 h-5 -ml-[1.5px] -mt-[1px]" fill="#0B100F">
...
export function AgentCarousel() {
  ...
  return (
    <div className="flex items-center gap-2 text-sm text-foreground" style={{ fontFamily: "var(--font-heading)", fontWeight: 300 }}>
      <span className="tracking-[0.15em] text-xs">Copy onboarding prompt for auto-setup</span>
