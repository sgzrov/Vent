...
// Copy relay-client bundle (served to connecting relay clients)
cpSync(
  path.resolve(packages, "relay-client/dist/relay-client.mjs"),
  path.resolve(__dirname, "../dist/relay-client.mjs")
);
